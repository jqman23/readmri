...
- Imports individual `.dcm`/extensionless DICOM files, whole study folders or mounted CD exports, common archive formats (`.zip`, `.tar`, `.tgz`, `.gz`), and MP4/MOV video exports in the browser before grouping slices/frames for review.
- Renders uncompressed grayscale MR slices, RLE-compressed slices, browser-decodable encapsulated JPEG/JPEG 2000 DICOM frames, and user-specified MP4/MOV frames to canvas-backed PNGs for review.
